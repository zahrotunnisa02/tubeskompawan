  ...
  <header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid position-relative d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center me-auto me-xl-0">
        ...
        <h1 class="sitename">HangoutHub</h1><span>.</span>
      </a>
  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-10">
            <h2 data-aos="fade-up" data-aos-delay="100">Welcome to HangoutHub</h2>
            <p data-aos="fade-up" data-aos-delay="200">Let's find a more productive place for our meeting.</p>
          </div>
          <div class="col-lg-5" data-aos="fade-up" data-aos-delay="300">
            <a href="cafe-finder/index.html">
              <button id="findCafeButton" class="btn btn-primary" type="button">Cari Cafe</button>
            </a>
